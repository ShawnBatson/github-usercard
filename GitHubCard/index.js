...
*/
  ...
  axios
    ...
    .then(res => {
      console.log(res)
      const followCard = res.data
      cards.appendChild(createCard(followCard))
    })
    .catch(err => {
      console.log("you hit an error", err)
    })
  ...
  followersArray.forEach(follower => {
    axios
      ...
      .then(res1 => {
        const followerCardA = res1.data
        cards.appendChild(createCard(followerCardA))
      })
      .catch(err => {
        console.log("you hit an error", err)
      })
...
//   const nextInLine = followersArray.forEach(() => {
//     for (let i = 0; i < followersArray.length; i++ ) {
//       axios.get(`https://api.github.com/users/${followersArray[i]}`)
//       .then((res1) => {
//         const followerCardA = (res1.data);
//         createCard(followerCardA);
